...
pub use stm32mp157x::{chip, clocks, gpio, nvic, rcc, tim2, usart};
...
pub static IRQS: [unsafe extern "C" fn(); 62] = [
    ...
    CortexM4F::GENERIC_ISR, // SUBGHZ_SPI
    ...
    CortexM4F::GENERIC_ISR, // DMA2_CH1 (54)
    CortexM4F::GENERIC_ISR, // DMA2_CH2 (55)
    CortexM4F::GENERIC_ISR, // DMA2_CH3 (56)
    CortexM4F::GENERIC_ISR, // DMA2_CH4 (57)
    CortexM4F::GENERIC_ISR, // DMA2_CH5 (58)
    CortexM4F::GENERIC_ISR, // DMA2_CH6 (59)
    CortexM4F::GENERIC_ISR, // DMA2_CH7 (60)
