...
impl<'a, ChipSpecs: ChipSpecsTrait> Clocks<'a, ChipSpecs> {
    ...
    pub(crate) fn set_flash(&self) {
        unimplemented!("Flash dependency not yet implemented for clocks");
    }
...
impl<'a, ChipSpecs: ChipSpecsTrait> Stm32mp157xClocks for Clocks<'a, ChipSpecs> {
